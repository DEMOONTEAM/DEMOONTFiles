...
if DevAbs:get(DEMOONT.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(DEMOONT.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(DEMOONT.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(DEMOONT.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(DEMOONT.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(DEMOONT.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DEMOONTName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DEMOONTName then 
DEMOONTNames = DevAbs:smembers(DEMOONT.."Abs:Mute:Names"..msg.chat_id_) or ""
if DEMOONTNames and DEMOONTNames[1] then 
for i=1,#DEMOONTNames do 
if DEMOONTName:match("(.*)("..DEMOONTNames[i]..")(.*)") then 
...
DevAbs:set(DEMOONT.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(DEMOONT.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
